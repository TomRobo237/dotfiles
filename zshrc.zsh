...
# OSX Section
        ...
        PATH="${PATH}:${HOME}/ubin:${HOME}/ubin/sicom_tools"
...
# Source ADT things
source ~/.adtzsh
source /Users/tmiller/git/personal/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh
